...
class GetCurrentWeatherJobService : JobService() {
    ...
    companion object {
        ...
        internal const val APP_ID = "838f88afc17ac353189cc1dd5025ced4"
    }
    ...
    private fun getCurrentWeather(job : JobParameters) {
        ...
        client.get(url, object : AsyncHttpResponseHandler() {
            override fun onSuccess(
                ...
                try {
                    ...
                    */
                    ...
                    // ketika terjadi error, maka jobFinished diset dengan parameter true. Yang artinya job perlu di reschedul
            ...
            override fun onFailure(
                ...
                // ketika proses gagal, maka jobFinished diset dengan parameter true. Yang artinya job perlu di reschedulee
                jobFinished(job, true)
            }
